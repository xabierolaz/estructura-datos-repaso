...
- `cuadernos/`: cuadernos `.ipynb` por tema para aprender teoria y codigo a la vez, preparados para Google Colab y utilizables desde Codespaces.
...
- `practica/`: ejercicios `.py` pensados para abrir y trabajar en Spyder.
...
- el flujo recomendado para `cuadernos/` es GitHub + Google Colab para estudio rapido y GitHub Classroom + Codespaces para despliegue docente
...
- la `practica/` existe para transferir lo aprendido al formato `.py` mas parecido al cierre real
