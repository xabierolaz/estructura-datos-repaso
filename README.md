...
2. el cuaderno del bloque que quieras revisar
3. [entrega_spyder.py](entrega_spyder.py)

## Archivos importantes

- [autoevaluacion.md](autoevaluacion.md): hoja breve por bloques con preguntas y respuestas al final.
...
- [B04_deque_priority_queue.ipynb](B04_deque_priority_queue.ipynb)
- [B05_buffers_circulares.ipynb](B05_buffers_circulares.ipynb)
- [B06_linked_lists.ipynb](B06_linked_lists.ipynb)
- [entrega_spyder.py](entrega_spyder.py): unica entrega del repositorio.

## Inicio rapido

1. Abre [autoevaluacion.md](autoevaluacion.md).
2. Responde y comparala con las respuestas del final.
3. Abre el cuaderno del bloque que quieras revisar.
